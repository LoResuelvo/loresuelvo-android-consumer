 ...
 * The per-scenario glue lives in `SendMessagesSteps.kt` for green
 * scenarios and in `PendingSteps.kt` for the `@wip` placeholders
 * (07-10-IC are the next batch — real-time chat over WebSocket).
 *
